...
export const ABOUT_CONTENT: AboutContent = {
  story: {
    ...
    paragraphs: [
      ...
      "What started as a small team has grown into a trusted agency serving 100+ clients across Sangli and surrounding regions. We offer security guard services, bouncer services, and housekeeping — all delivered by trained, uniformed, and disciplined personnel.",
